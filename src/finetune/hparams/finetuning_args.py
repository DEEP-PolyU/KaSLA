...
class RLHFArguments:
    ...
    ppo_ftx: Optional[float] = field(
        default=0, metadata={"help": "The supervised fine-tuning loss coefficient in PPO training."}
    )
    sft_ftx: Optional[float] = field(
        default=0, metadata={"help": "The supervised fine-tuning loss coefficient in sft training."}
    )
    correct_mask: Optional[bool] = field(
        default=False, metadata={"help": 'correct_mask.'}
    )
    sft_topk_sampling: Optional[int] = field(
        default=0, metadata={"help": "sft_topk_sampling."}
    )
...
class FinetuningArguments(FreezeArguments, LoraArguments, RLHFArguments):
    ...
    """
    stage: Optional[Literal["pt", "sft", "rm", "ppo", "dpo", "align", "sup"]] = field(
