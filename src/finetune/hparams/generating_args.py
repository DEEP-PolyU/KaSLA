...
class GeneratingArguments:
    ...
    database_path: Optional[str] = field(
        default=None, metadata={"help": "Which database will be used for execution in training."}
    )
    # do_loop: Optional[bool] = field(
    #     default=False, metadata={"help": "Whether or not to inference in the loop."}
    # )
