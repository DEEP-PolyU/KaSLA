...
class PPOTrainer(BaseTrainer):
    ...
    def _set_signature_columns_if_needed(self):
        if self._signature_columns is None:
            ...
            self._signature_columns += ["labels", "query", "response"]
    ...
    def compute_rewards(
        ...
        for score, logprob, ref_logprob, mask in zip(scores, logprobs, ref_logprobs, masks):
            ...
            print("kl.size() {}".format(kl.size()))
            print("reward.size() {}".format(reward.size()))
            print("last_non_masked_index {}".format(last_non_masked_index))
