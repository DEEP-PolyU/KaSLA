...
def check_sql_executability_with_execution_results(generated_sql, db):
    ...
    try:
        ...
        execution_results = execute_sql(cursor, generated_sql)
    ...
    return execution_error, execution_results
